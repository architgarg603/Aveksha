...
async function cbtnHandler (e) {
    try {
        e.preventDefault(); 
        let obj = await axios.post("https://aveksha.herokuapp.com/user/signup",{name: username.value, email:email.value,phone:phone.value,orgName: org.value,Designation:Designation.value,password:pw.value,confirmPassword:cpw.value});
